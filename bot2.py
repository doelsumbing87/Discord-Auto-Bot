...
def generate_reply(prompt, prompt_language, use_google_ai=True, author_id=None, is_quiz=False):
    global last_generated_text
    # Handle bot/AI identification questions
    ...
    if is_quiz:
        ...
        if emoji:
            ...
            animal_map = {
                ...
                '🐃': 'water buffalo', '🐂': 'ox', '🐄': 'cow', '🐎': 'horse', '🐖': 'pig', '🐏': 'ram', '🐑': 'sheep',
        ...
        while True:
            try:
                ...
                if response.status_code == 429:
                    ...
                    return generate_reply(prompt, prompt_language, use_google_ai, author_id, is_quiz)
        ...
        while True:
            ...
            try:
                ...
                if messages:
                    ...
                    quiz_pattern = r'^\s*[🐷🐮🐶🐱🐭🐹🐰🐻🐼🐨🐯🦁🐸🐵🐔🐧🐦🐤🐣🐺🦊🦝🐗🐴🦄🐝🐛🦋🐞🐜🦗🕷️🦂🐍🐢🐙🦑🦐🦞🦀🐡🐠🐟🐬🐳🐋🦈🐊🐅🐆🦒🐘🦏🦛🐪🐫🦘🐃🐂🐄🐎🐖🐏🐑🦙🐐🐓🦃🦚🦜🦢🦩🐕‍🦺🦮🐈‍⬛]\s*-?\s*(which animal|what animal|guess the animal|what is this)\b'
                    ...
                    # Handle regular messages
                        ...
                        if attachments or not re.search(r'\w', user_message):
                            ...
                            # Randomly choose reply target: latest, previous, or none
            ...
            if prompt:
                ...
                result = generate_reply(prompt, settings["prompt_language"], settings["use_google_ai"], author_id, is_quiz)
                if result is None:
                    ...
                    if response_text.strip().lower() == prompt.strip().lower():
                        ...
                        # Randomly decide to tag someone
